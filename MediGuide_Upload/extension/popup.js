document.addEventListener("DOMContentLoaded", () => {
  ...
  const i18n = {
    ko: {
      ...
      errorTitle: "🚨 진단 실패",
      errorHint: "구글 API 할당량 초과 또는 클라우드 서버 상태를 확인하세요."
    },
    en: {
      ...
      errorHint: "Google API Quota Exceeded. Retrying with a backup model or wait a few seconds."
    }
  };
